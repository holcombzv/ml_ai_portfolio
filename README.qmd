...
As a personal project, I created a recurrant neural network from scratch that can predict whether a news article contains real or fake news. I achieved an accuracy of 97.5%. Methods used include data formatting and tokenization, long short-term memory, and dropout layers. I then deployed the model on a prototype [Hugging Face Spaces web app](https://huggingface.co/spaces/holcombzv/fact_checker_streamlit).
